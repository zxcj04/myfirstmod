...
public class InWorldRenderer
{
	...
	private static void drawLine(IVertexBuilder builder, Matrix4f positionMatrix, BlockPos pos, int dx1, int dy1, int dz1, int dx2, int dy2, int dz2, Vector4f color)
	{
	...
	private static void showTileEntities(ClientPlayerEntity player, MatrixStack matrixStack)
	{
		...
		matrixStack.translate(playerPos.getX() - projectrdView.x, playerPos.getY() - projectrdView.y, playerPos.getZ() - projectrdView.z);
