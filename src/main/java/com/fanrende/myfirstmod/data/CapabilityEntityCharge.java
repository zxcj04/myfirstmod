...
public class CapabilityEntityCharge
{
	...
	public static class Storage implements Capability.IStorage<IEntityCharge>
	{
		...
		public INBT writeNBT(
				Capability<IEntityCharge> capability, IEntityCharge instance, Direction side
		)
		{
		...
		@Override
		public void readNBT(
				Capability<IEntityCharge> capability, IEntityCharge instance, Direction side, INBT nbt
		)
		{
